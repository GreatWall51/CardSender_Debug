...
typedef enum
{
    ...
    BEEP_OPEN_READ_MODE = 0x01,               //刷卡声音
    BEEP_CARD_2_MODE =0x03,                   //响2声
	
    
    BEEP_CARD_1_MODE = 0x02,                  //响1声
    BEEP_CARD_4_MODE =0x06,                   //响4声
    BEEP_ADDR_MODE  = 0x10,                   //地址变化声音
}BEEP_MODE_E;


/*------------------------ Variable Define/Declarations ----------------------*/
#define  BEEP_TIME_100M      15   //8ms * 25 = 200ms
